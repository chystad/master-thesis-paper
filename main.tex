...
% Insert external PDF as its own page after the title page
\cleardoublepage
\includepdf[
    pages=1,
    pagecommand={},
    fitpaper=true
]{Chapters/0aMaster_thesis_AI_declaration.pdf}
\cleardoublepage
...
\input{Chapters/0bAbstract.tex}

\chapter*{Sammendrag}
\addcontentsline{toc}{chapter}{Sammendrag}
\input{Chapters/0cSammendrag.tex}

\chapter*{Preface}
\addcontentsline{toc}{chapter}{Preface}
\input{Chapters/0dPreface.tex}
...
\input{Chapters/05Propagator.tex}
\cleardoublepage


\chapter{GNSS-R Formation Flight Simulator}
\label{chap:lifetime}
\input{Chapters/06Formation.tex}
\cleardoublepage


\chapter{Shared Simulator Configuration}
\label{chap:shared}
\input{Chapters/04Shared.tex}
\cleardoublepage


\chapter{Mission Analysis Methodology}
\label{chap:experiments}
\input{Chapters/07Experiments.tex}
\cleardoublepage


\chapter{Results}
\label{chap:results}
\input{Chapters/08Results}
\cleardoublepage
...
\fancyfoot[C]{\thepage} % set appendix page numbers in the center of the footer

% Keep appendix page numbering separate from the main text.
% Remove these two lines if you prefer continuous Arabic page numbering.
\pagenumbering{roman}
\setcounter{page}{1}

% Make appendix chapter numbers appear as "A -" in the table of contents and headings.
% Section numbers are redefined separately to avoid forms such as "A -.1".
\renewcommand{\thechapter}{\Alph{chapter} -}
\renewcommand{\thesection}{\Alph{chapter}.\arabic{section}}

% Add a non-numbered appendix group label to the ToC.
% Individual appendices are now added automatically by \chapter in 11Appendix.tex.
\addtocontents{toc}{\protect\contentsline{chapter}{\protect\numberline{}Appendices:}{}{}}

\input{Chapters/11Appendix}
